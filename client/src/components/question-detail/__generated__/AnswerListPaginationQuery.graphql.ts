...
export type AnswerListPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"AnswerListFragment">;
  } | null | undefined;
};
export type AnswerListPaginationQuery = {
  response: AnswerListPaginationQuery$data;
  variables: AnswerListPaginationQuery$variables;
};
