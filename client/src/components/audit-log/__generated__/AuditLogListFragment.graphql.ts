...
export type AuditLogListFragment$data = {
  ...
  readonly " $fragmentType": "AuditLogListFragment";
};
export type AuditLogListFragment$key = {
  readonly " $data"?: AuditLogListFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"AuditLogListFragment">;
};

import AuditLogListPaginationQuery_graphql from './AuditLogListPaginationQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": AuditLogListPaginationQuery_graphql
    }
  },
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__AuditLogListFragment_auditLogs_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
